...
int choice = Integer.parseInt(request.getParameter("filterByMeals"));

int counter = 0;
ResultSet rset = hotelDao.FilterByMeals(conn,choice, location);
ResultSet rs = hotelDao.FilterByMeals(conn,choice, location);
