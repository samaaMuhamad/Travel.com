...
int choice = Integer.parseInt(request.getParameter("filterByprice"));
int counter = 0;
ResultSet rset = hotelDao.FilterByPrice(conn,choice, location);
ResultSet rs = hotelDao.FilterByPrice(conn,choice, location);
