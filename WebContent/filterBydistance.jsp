...
int choice = Integer.parseInt(request.getParameter("filterBydistance"));
int counter = 0;
ResultSet rset = hotelDao.FilterBydistance(conn,choice, location);
ResultSet rs = hotelDao.FilterBydistance(conn,choice, location);
