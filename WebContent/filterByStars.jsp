...
int choice = Integer.parseInt(request.getParameter("filterBystars"));
 
int counter = 0;
ResultSet rset = hotelDao.FilterByStars(conn,choice, location);
ResultSet rs = hotelDao.FilterByStars(conn,choice, location);
