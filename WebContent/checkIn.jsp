	...
	<div class="row my-5 mx-0">
		<div class="card col-4 mx-auto p-0">
			<div class="card-header col-12">
				<h4 class="card-title mt-2">Check IN Reservation</h4>
			</div>
			<div class="card-body">
				<form name ="checkIn" method="POST" action="checkIn">
					<div class="form-row">
					...
					<div id="show"></div>
					<button type="submit" class="btn btn-primary px-5 w-100" value="Check in" onclick="ajaxValidation()">Check IN</button>
				</form>
			</div>
		</div>
	</div>
...
<script src="bootstrap/js/main.js"></script>
    ...
    function checkIDExist(){
        ...
        var id =  document.getElementById("id").value;	        var url = "existID.jsp?reservationID=" + id;
